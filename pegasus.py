...
def get_pegasus(size, number: str = "001"):
    df = pd.read_csv(f"/home/tsmierzchalski/PycharmProjects/D-Wave_Scripts/instances/cross_only/P2/{number}.txt",
...
sampleset = solver.sample_ising(h, J, num_reads=1, label="Pegasus")
