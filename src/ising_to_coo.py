...
if __name__ == "__main__":
    for i in tqdm(range(1, 101)):
        ...
        instance = pd.read_csv(os.path.join(cwd, "..", "instances", "zephyr_random", "Z2", "RCO", name_full),
        ...
        with open(os.path.join(cwd, "..", f"instances/zephyr_random/Z2/RCO/COO/{name}.txt"), "w") as f:
            coo.dump(bqm, f)
