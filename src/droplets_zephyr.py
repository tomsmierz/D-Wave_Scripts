...
json_directory1 = os.path.join(root, "droplets", INSTANCE_SYMBOL, INSTANCE_TYPE, "droplets", f"final_bench_truncate2^{TRUNCATION}")
json_directory2 = os.path.join(root, "droplets", INSTANCE_SYMBOL, INSTANCE_TYPE, "droplets", f"final_bench_truncate2^{TRUNCATION2}")
...
h5_directory = os.path.join(root, "energies", "sbm", f"{TOPOLOGY}_random", INSTANCE_SYMBOL, INSTANCE_TYPE, "filtered_files_hd50_ar05_i020")
minimum_path = os.path.join(root, "droplets", INSTANCE_SYMBOL, INSTANCE_TYPE, f"best_all.csv")
